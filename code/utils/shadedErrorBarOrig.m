function varargout=shadedErrorBarOrig(x,y,errBar,color,varargin)
...
%
% 1)
% shadedErrorBarOrig(x,mean(y,1),std(y),'lineprops','g');
%
% 2)
...
H = makePlot(x,y,errBar,color,lineProps,transparent,patchSaturation);
...
function H = makePlot(x,y,errBar,col,lineProps,transparent,patchSaturation)
