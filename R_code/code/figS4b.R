## Creates the basic plots for supplemental figure S4b (laterality of ROIs)
...
files <- dir(paste0(path), 
             pattern = "*ContraVSIpsi_10_40.mat")
...
p
ggsave("figs/S4b_ve10.pdf", p, width=7, height=5)

##Stats
subs.tidy <- gather(full, ROI, mean, 4:7)
